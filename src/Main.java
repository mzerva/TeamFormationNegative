...
public class Main {
	...
	public static void main(String[] args){
		...
		//Epinions
		/*
		//String pairValuesPath="data\\epinions\\more_positive_paths_compatibility.txt";
		//String pairValuesPath="data\\epinions\\one_positive_path_compatibility.txt";
		String pairValuesPath="data\\epinions\\no_negative_paths_compatibility.txt";
		String networkPath="data\\epinions\\network.txt"; 
		String userPath="data\\epinions\\users.txt";
		String skillPath="data\\epinions\\skills.txt";*/
		
		//SlashDot
		//String pairValuesPath="data\\slashdot\\more_positive_paths_compatibility.txt";
		//String pairValuesPath="data\\slashdot\\one_positive_path_compatibility.txt";
